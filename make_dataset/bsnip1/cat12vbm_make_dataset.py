...
OUTPUT_DIR = "/neurospin/psy_sbox/analyses/202205_predict_neurodev/data/bsnip1/"
...
def read_data():
    ...
    qc = pd.read_csv(os.path.join(STUDY_PATH,
        'derivatives/cat12-12.6_vbm_qc_2018/qc.tsv'), sep='\t')
    ...
    rois = pd.read_csv(os.path.join(STUDY_PATH,
        'derivatives/cat12-12.6_vbm_roi_2018/cat12-12.6_vbm_roi.tsv'), sep='\t')
