...
output_dir = os.path.join(neurospin, "dico", "data", "deep_folding", "current", "datasets")
...
parallel = True
number_subjects = -1  # all subjects : -1
bids = True
...
skeleton_dir = os.path.join(output_dir, study, "skeletons", "raw")
