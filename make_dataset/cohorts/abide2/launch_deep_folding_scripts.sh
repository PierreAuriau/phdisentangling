...
# Generate skeletons
#python3 ${DEEP_FOLDING_DIR}/brainvisa/generate_skeletons.py --src_dir $SRC_DIR --output_dir $SKELETON_DIR --side $SIDE --path_to_graph $PATH_TO_GRAPH --nb_subjects $NB_SUBJECT --bids -a
