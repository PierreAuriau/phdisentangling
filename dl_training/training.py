...
from dl_training.models.cnn import CNN
from dl_training.temp_datamanager import TemporaryDataManager
...
class BaseTrainer:
    ...
    def build_network(name, pb, **kwargs):
        ...
        if name == "resnet18":
            ...
            if pb == "self_supervised":
                ...
                net = SFCN(num_classes=num_classes, dropout=True, **kwargs)
            ...
            net = CNN(z_dim=256, input_shape=(128, 160, 128), num_classes=num_classes)
        else:
    ...
    def build_data_manager(args):
        ...
        if args.N_train_max == 1:
            _manager_cls = TemporaryDataManager
